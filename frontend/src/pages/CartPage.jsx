    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      {isEmpty ? (
        <div className="text-center py-20">
          ...
          <p className="text-gray-400 text-lg mb-6">Sepetiniz boş</p>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div key={item.id} className="bg-white rounded-xl border border-gray-100 p-5 flex items-center justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-500 mt-1">
                    {item.itemType === 'PACKAGE' ? '📦 Paket' : '🎯 Hizmet'} — {item.quantity} adet
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="text-gray-400 text-xs">₺{item.unitPrice?.toLocaleString('tr-TR')} / adet</div>
                </div>
                <button
          ...
          <div className="lg:w-72">
            <div className="bg-white rounded-xl border border-gray-100 p-6 sticky top-20">
              <h3 className="font-bold text-gray-900 text-lg mb-4">Sipariş Özeti</h3>
              ...
              <div className="border-t border-gray-100 pt-4 flex justify-between font-bold text-gray-900 text-lg mb-6">
                <span>Toplam</span>
                <span className="text-blue-600">₺{cart.total?.toLocaleString('tr-TR')}</span>
              </div>
              <button
