...
const STATUS_LABELS = { PENDING: 'Pending', PAID: 'Paid', CANCELLED: 'Cancelled', REFUNDED: 'Refunded' }
          ...
          <tbody className="divide-y divide-gray-50">
            {orders.map((o) => (
              <tr key={o.id} className="hover:bg-gray-50">
                ...
                <td className="p-4 text-gray-500">{new Date(o.createdAt).toLocaleDateString('en-US')}</td>
                <td className="p-4 font-bold text-blue-600">₺{o.totalAmount?.toLocaleString('en-US')}</td>
                <td className="p-4">
